...
_GETREVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='hipstershop.GetReviewRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='hipstershop.GetReviewRequest.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTREVIEWSREQUEST = _descriptor.Descriptor(
  ...
  full_name='hipstershop.ListReviewsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='user_id', full_name='hipstershop.ListReviewsRequest.user_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='product_id', full_name='hipstershop.ListReviewsRequest.product_id', index=1,
      number=2, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTREVIEWSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='hipstershop.ListReviewsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='reviews', full_name='hipstershop.ListReviewsResponse.reviews', index=0,
...
_REVIEW = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='hipstershop.Review.id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='name', full_name='hipstershop.Review.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='user', full_name='hipstershop.Review.user', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='stars', full_name='hipstershop.Review.stars', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='review', full_name='hipstershop.Review.review', index=4,
...
_LISTREVIEWSRESPONSE.fields_by_name['reviews'].message_type = _REVIEW
...
GetReviewRequest = _reflection.GeneratedProtocolMessageType('GetReviewRequest', (_message.Message,), {
  ...
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.GetReviewRequest)
  })
...
ListReviewsRequest = _reflection.GeneratedProtocolMessageType('ListReviewsRequest', (_message.Message,), {
  ...
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.ListReviewsRequest)
  })
...
ListReviewsResponse = _reflection.GeneratedProtocolMessageType('ListReviewsResponse', (_message.Message,), {
  ...
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.ListReviewsResponse)
  })
...
Review = _reflection.GeneratedProtocolMessageType('Review', (_message.Message,), {
  'DESCRIPTOR' : _REVIEW,
  '__module__' : 'demo_pb2'
  # @@protoc_insertion_point(class_scope:hipstershop.Review)
  })
...
_REVIEWSERVICE = _descriptor.ServiceDescriptor(
  name='ReviewService',
  full_name='hipstershop.ReviewService',
  file=DESCRIPTOR,
  index=2,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='ListReviews',
    full_name='hipstershop.ReviewService.ListReviews',
    index=0,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetReview',
    full_name='hipstershop.ReviewService.GetReview',
    index=1,
    containing_service=None,
